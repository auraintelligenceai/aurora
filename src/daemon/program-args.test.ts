...
describe("resolveGatewayProgramArguments", () => {
  ...
  it("prefers symlinked path over realpath for stable service config", async () => {
    // Simulates pnpm global install where node_modules/aura_intelligence is a symlink
    // to .pnpm/aura_intelligence@X.Y.Z/node_modules/aura_intelligence
    const symlinkPath = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/aura_intelligence/dist/entry.js",
    );
    const realpathResolved = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/aura_intelligence@2026.1.21-2/node_modules/aura_intelligence/dist/entry.js",
    );
