...
import { writeConfigFile, type aura_intelligenceConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: aura_intelligenceConfig | null) {
