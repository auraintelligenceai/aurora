...
export async function updateConfig(
  mutator: (cfg: aura_intelligenceConfig) => aura_intelligenceConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: aura_intelligenceConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: aura_intelligenceConfig): Set<string> {
