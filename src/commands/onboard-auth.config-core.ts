...
export function applyZaiConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyVercelAiGatewayConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyOpenrouterConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyMoonshotProviderConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyKimiCodeProviderConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applySyntheticConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
