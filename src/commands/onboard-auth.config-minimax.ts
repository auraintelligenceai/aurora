...
export function applyMinimaxProviderConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyMinimaxConfig(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
