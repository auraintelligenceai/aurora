...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "aura_intelligence-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<aura_intelligenceConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<aura_intelligenceConfig["telegram"]>>,
