...
export function summarizeExistingConfig(config: aura_intelligenceConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.auraintelligence.ai/gateway/remote",
    "https://docs.auraintelligence.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
