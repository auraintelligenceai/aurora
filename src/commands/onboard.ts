    ...
    runtime.error(
      [
        "Non-interactive onboarding requires explicit risk acknowledgement.",
         "Read: https://docs.auraintelligence.ai/security",
        `Re-run with: ${formatCliCommand("aura_intelligence onboard --non-interactive --accept-risk ...")}`,
      ].join("\n"),
    );
    runtime.exit(1);
    return;
  ...
  if (process.platform === "win32") {
    runtime.log(
      [
        ...
        "Guide: https://docs.auraintelligence.ai/windows",
      ].join("\n"),
    );
  }
