...
export async function persistInlineDirectives(params: {
  ...
  agentCfg: NonNullable<aura_intelligenceConfig["agents"]>["defaults"] | undefined;
...
export function resolveDefaultModel(params: { cfg: aura_intelligenceConfig; agentId?: string }): {
  defaultProvider: string;
  defaultModel: string;
  aliasIndex: ModelAliasIndex;
} {
