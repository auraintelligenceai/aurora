import type { aura_intelligenceConfig } from "../config/types.js";
...
export function isCommandEnabled(cfg: aura_intelligenceConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: aura_intelligenceConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: aura_intelligenceConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: aura_intelligenceConfig) {
