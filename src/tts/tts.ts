...
export function resolveTtsConfig(cfg: aura_intelligenceConfig): ResolvedTtsConfig {
...
export function buildTtsSystemPromptHint(cfg: aura_intelligenceConfig): string | undefined {
