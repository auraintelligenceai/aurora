...
${formatHelpExamples([
  ['aura_intelligence agent --to +15555550123 --message "status update"', "Start a new session."],
  ['aura_intelligence agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
