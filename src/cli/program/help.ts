...
const EXAMPLES = [
  ...
  ["aura_intelligence gateway --port 18790", "Run the WebSocket Gateway locally."],
  [
  ...
  [
    'aura_intelligence message send --channel telegram --target @mychat --message "Hi"',
...
export function configureProgramHelp(program: Command, ctx: ProgramContext) {
  program
    ...
    .option(
      "--dev",
      "Dev profile: isolate state under ~/.aura-dev, default gateway port 19001, and shift derived ports (browser/canvas)",
    )
    .option(
      "--profile <name>",
