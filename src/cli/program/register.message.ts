...
${formatHelpExamples([
  ['aura_intelligence message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'aura_intelligence message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'aura_intelligence message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}
