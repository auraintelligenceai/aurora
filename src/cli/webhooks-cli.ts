...
export function registerWebhooksCli(program: Command) {
  ...
  gmail
    .command("setup")
    .description("Configure Gmail watch + Pub/Sub + aura_intelligence hooks")
    ...
    .option("--hook-url <url>", "aura_intelligence hook URL")
    .option("--hook-token <token>", "aura_intelligence hook token")
