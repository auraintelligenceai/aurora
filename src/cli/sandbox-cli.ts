...
const SANDBOX_EXAMPLES = {
  main: [
    ["aura_intelligence sandbox list", "List all sandbox containers."],
    ...
    ["aura_intelligence sandbox recreate --agent mybot", "Recreate agent containers."],
    ["aura_intelligence sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["aura_intelligence sandbox list", "List all sandbox containers."],
    ["aura_intelligence sandbox list --browser", "List only browser containers."],
  ...
  explain: [
    ["aura_intelligence sandbox explain", "Show effective sandbox config."],
    ["aura_intelligence sandbox explain --session agent:main:main", "Explain a specific session."],
    ["aura_intelligence sandbox explain --agent work", "Explain an agent sandbox."],
    ["aura_intelligence sandbox explain --json", "JSON output."],
  ],
} as const;
