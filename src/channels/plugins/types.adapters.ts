...
export type ChannelSetupAdapter = {
  resolveAccountId?: (params: { cfg: aura_intelligenceConfig; accountId?: string }) => string;
...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: aura_intelligenceConfig) => string[];
  resolveAccount: (cfg: aura_intelligenceConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: aura_intelligenceConfig) => string;
