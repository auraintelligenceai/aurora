...
export function supportsChannelMessageButtons(cfg: aura_intelligenceConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: aura_intelligenceConfig): boolean {
  for (const plugin of listChannelPlugins()) {
