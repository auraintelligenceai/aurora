...
vi.mock("./aura_intelligence-root.js", () => ({
...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "aura_intelligence-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveaura_intelligencePackageRoot } = await import("./aura_intelligence-root.js");
    ...
    vi.mocked(resolveaura_intelligencePackageRoot).mockResolvedValue("/opt/aura_intelligence");
    vi.mocked(checkUpdateStatus).mockResolvedValue({
      root: "/opt/aura_intelligence",
      installKind: "package",
      packageManager: "npm",
