...
export const A2UI_PATH = "/__aura_intelligence__/a2ui";
export const CANVAS_HOST_PATH = "/__aura_intelligence__/canvas";
export const CANVAS_WS_PATH = "/__aura_intelligence/ws";
...
(() => {
  ...
  const handlerNames = ["aura_intelligenceCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.aura_intelligence = globalThis.aura_intelligence ?? {};
  globalThis.aura_intelligence.postMessage = postToNode;
