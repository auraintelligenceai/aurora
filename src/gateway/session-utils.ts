...
import { type aura_intelligenceConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: aura_intelligenceConfig): string[] {
...
export function listAgentsForGateway(cfg: aura_intelligenceConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: aura_intelligenceConfig): string {
...
function resolveSessionStoreAgentId(cfg: aura_intelligenceConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: aura_intelligenceConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: aura_intelligenceConfig): GatewaySessionsDefaults {
