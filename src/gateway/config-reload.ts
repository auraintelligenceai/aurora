...
export function resolveGatewayReloadSettings(cfg: aura_intelligenceConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: aura_intelligenceConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: aura_intelligenceConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: aura_intelligenceConfig) => void;
  log: {
