export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "aura_intelligence-control-ui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "aura_intelligence-macos",
  IOS_APP: "aura_intelligence-ios",
  ANDROID_APP: "aura_intelligence-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "aura_intelligence-probe",
} as const;
