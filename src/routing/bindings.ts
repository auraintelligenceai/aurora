...
export function listBindings(cfg: aura_intelligenceConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: aura_intelligenceConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: aura_intelligenceConfig) {
