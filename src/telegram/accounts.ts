...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AURA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: aura_intelligenceConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: aura_intelligenceConfig): string {
