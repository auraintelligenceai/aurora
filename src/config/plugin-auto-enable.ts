import type { aura_intelligenceConfig } from "./config.js";
import {
  getChatChannelMeta,
  listChatChannels,
...
function isTelegramConfigured(cfg: aura_intelligenceConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: aura_intelligenceConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: aura_intelligenceConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: aura_intelligenceConfig): boolean {
...
function isIMessageConfigured(cfg: aura_intelligenceConfig): boolean {
...
function isWhatsAppConfigured(cfg: aura_intelligenceConfig): boolean {
...
function isGenericChannelConfigured(cfg: aura_intelligenceConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: aura_intelligenceConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: aura_intelligenceConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: aura_intelligenceConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: aura_intelligenceConfig, pluginId: string): boolean {
