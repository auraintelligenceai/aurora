...
export function applyConfigOverrides(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
  if (!overrides || Object.keys(overrides).length === 0) return cfg;
  return mergeOverrides(cfg, overrides) as aura_intelligenceConfig;
}
