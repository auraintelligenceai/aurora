...
export function applyMessageDefaults(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applySessionDefaults(
  ...
  const next: aura_intelligenceConfig = {
    ...cfg,
...
export function applyTalkApiKey(config: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyModelDefaults(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyLoggingDefaults(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyContextPruningDefaults(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
...
export function applyCompactionDefaults(cfg: aura_intelligenceConfig): aura_intelligenceConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
