...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveaura_intelligenceAgentDir() returns mainAgentDir
    process.env.AURA_STATE_DIR = tmpDir;
    process.env.AURA_AGENT_DIR = mainAgentDir;
