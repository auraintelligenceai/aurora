...
type WebFetchConfig = NonNullable<aura_intelligenceConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: aura_intelligenceConfig): WebFetchConfig {
