...
function resolveDefaultModelRef(cfg?: aura_intelligenceConfig): {
  provider: string;
  model: string;
} {
  if (cfg) {
...
function pickMaxBytes(cfg?: aura_intelligenceConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const effectiveCfg: aura_intelligenceConfig | undefined = params.cfg
    ? {
        ...params.cfg,
        agents: {
          ...params.cfg.agents,
  ...
  await ensureaura_intelligenceModelsJson(effectiveCfg, params.agentDir);
