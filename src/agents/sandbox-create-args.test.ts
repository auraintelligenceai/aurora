...
describe("buildSandboxCreateArgs", () => {
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "aura_intelligence-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "aura_intelligence.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        "create",
        "--name",
        "aura_intelligence-sbx-test",
        "--label",
        "aura_intelligence.sandbox=1",
        "--label",
        "aura_intelligence.sessionKey=main",
        "--label",
        "aura_intelligence.createdAtMs=1700000000000",
        "--label",
        "aura_intelligence.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
        ...
        "--security-opt",
        "apparmor=aura_intelligence-sandbox",
        "--dns",
        "1.1.1.1",
        "--add-host",
  ...
  it("emits -v flags for custom binds", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "aura_intelligence-sbx-binds",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
    });
  ...
  it("omits -v flags when binds is empty or undefined", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "aura_intelligence-sbx-no-binds",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
    });
