...
import {
  ...
  CLAUDE_PARAM_GROUPS,
  createaura_intelligenceReadTool,
...
function resolveExecConfig(cfg: aura_intelligenceConfig | undefined) {
...
export function createaura_intelligenceCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createaura_intelligenceReadTool(freshReadTool)];
    }
