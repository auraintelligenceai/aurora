...
describe("createaura_intelligenceCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    const config: aura_intelligenceConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createaura_intelligenceCodingTools({
      config,
    ...
    const anthropicTools = createaura_intelligenceCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createaura_intelligenceCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createaura_intelligenceCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
