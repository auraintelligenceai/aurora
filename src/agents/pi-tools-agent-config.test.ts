...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createaura_intelligenceCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createaura_intelligenceCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createaura_intelligenceCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createaura_intelligenceCodingTools({
      config: cfg,
    ...
    const bobTools = createaura_intelligenceCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createaura_intelligenceCodingTools({
      config: cfg,
