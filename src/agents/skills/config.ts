...
import type { aura_intelligenceConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: aura_intelligenceConfig | undefined, pathStr: string) {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "aura_intelligence-bundled";
}

export function resolveBundledAllowlist(config?: aura_intelligenceConfig): string[] | undefined {
