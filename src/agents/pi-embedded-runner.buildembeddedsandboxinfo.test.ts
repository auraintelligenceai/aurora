...
const _ensureModels = (cfg: aura_intelligenceConfig, agentDir: string) =>
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/aura_intelligence-sandbox",
      agentWorkspaceDir: "/tmp/aura_intelligence-workspace",
      ...
      browser: {
        ...
        containerName: "aura_intelligence-sbx-browser-test",
      },
