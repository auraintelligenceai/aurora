...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".aura", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "aura_intelligence-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "aura_intelligence-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "aura_intelligence-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "aura_intelligence-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "aura_intelligence-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".aura");
