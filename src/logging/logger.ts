...
export const DEFAULT_LOG_DIR = "/tmp/aura_intelligence";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "aura_intelligence.log"); // legacy single-file path

const LOG_PREFIX = "aura_intelligence";
...
function resolveSettings(): ResolvedSettings {
  let cfg: aura_intelligenceConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => aura_intelligenceConfig;
      };
