...
// package.json "aura_intelligence" metadata (used for onboarding/catalog)
...
export type aura_intelligencePackageManifest = {
  extensions?: string[];
...
): aura_intelligencePackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.aura_intelligence ?? manifest[LEGACY_MANIFEST_KEY];
}
