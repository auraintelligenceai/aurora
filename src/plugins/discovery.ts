...
import {
  ...
  type aura_intelligencePackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @aura_intelligence/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageaura_intelligence: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoveraura_intelligencePlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".aura", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
