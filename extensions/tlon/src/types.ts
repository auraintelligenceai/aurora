...
export function resolveTlonAccount(cfg: aura_intelligenceConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: aura_intelligenceConfig): string[] {
  const base = cfg.channels?.tlon as
