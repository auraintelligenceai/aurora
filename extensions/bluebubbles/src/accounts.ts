...
export function listBlueBubblesAccountIds(cfg: aura_intelligenceConfig): string[] {
  const ids = listConfiguredAccountIds(cfg);
  if (ids.length === 0) return [DEFAULT_ACCOUNT_ID];
  return ids.sort((a, b) => a.localeCompare(b));
}

export function resolveDefaultBlueBubblesAccountId(cfg: aura_intelligenceConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: aura_intelligenceConfig): ResolvedBlueBubblesAccount[] {
