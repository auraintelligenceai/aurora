...
function setBlueBubblesDmPolicy(cfg: aura_intelligenceConfig, dmPolicy: DmPolicy): aura_intelligenceConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your aura_intelligence gateway URL + webhook path",
