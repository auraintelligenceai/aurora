...
### Changes
- Version alignment with core aura_intelligence release numbers.
...
### Highlights
- First public release of the @aura_intelligence/voice-call plugin.
...
- CLI: `aura_intelligence voicecall` commands (call/start/continue/speak/end/status/tail/expose).
