...
import type { ReplyPayload, aura_intelligenceConfig } from "clawdbot/plugin-sdk";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // aura_intelligenceConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as aura_intelligenceConfig;
