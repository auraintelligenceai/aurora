import type { aura_intelligencePluginApi, LineChannelData, ReplyPayload } from "clawdbot/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: aura_intelligencePluginApi): void {
  api.registerCommand({
    name: "card",
