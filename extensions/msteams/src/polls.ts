...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["aura_intelligencePollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["aura_intelligence", "pollId"]) ??
    readNestedString(value, ["aura_intelligence", "poll", "id"]) ??
    readNestedString(value, ["data", "aura_intelligencePollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "aura_intelligence", "pollId"]);
    ...
    actions: [
      {
        ...
        title: "Vote",
        data: {
          aura_intelligencePollId: pollId,
        },
        msteams: {
          type: "messageBack",
          text: "aura_intelligence poll vote",
          displayText: "Vote recorded",
          value: { aura_intelligencePollId: pollId },
        },
      },
    ],
  };
