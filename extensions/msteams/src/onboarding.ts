...
function setMSTeamsDmPolicy(cfg: aura_intelligenceConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: aura_intelligenceConfig, allowFrom: string[]): aura_intelligenceConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
