...
#
# Output:
# - dist/aura_intelligence.app
# - dist/aura_intelligence-<version>.zip
# - dist/aura_intelligence-<version>.dmg
...
APP="$ROOT_DIR/dist/aura_intelligence.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/aura_intelligence-$VERSION.zip"
DMG="$ROOT_DIR/dist/aura_intelligence-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/aura_intelligence-$VERSION.notary.zip"
