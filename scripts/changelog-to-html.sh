...
if [[ -z "$version_content" ]]; then
  echo "<h2>aura_intelligence $VERSION</h2>"
  echo "<p>Latest aura_intelligence update.</p>"
  echo "<p><a href=\"https://github.com/aura_intelligence/aura_intelligence/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
