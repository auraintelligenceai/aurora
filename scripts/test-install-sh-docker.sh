...
SMOKE_IMAGE="${CLAWDBOT_INSTALL_SMOKE_IMAGE:-aura_intelligence-install-smoke:local}"
NONROOT_IMAGE="${CLAWDBOT_INSTALL_NONROOT_IMAGE:-aura_intelligence-install-nonroot:local}"
