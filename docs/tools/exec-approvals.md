...
- **gateway host** → `aura_intelligence` process on the gateway machine
...
`~/.aura/exec-approvals.json` directly.

CLI: `aura_intelligence approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
