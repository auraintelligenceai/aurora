---
summary: "Fix Chrome/Brave/Edge/Chromium CDP startup issues for aura_intelligence browser control on Linux"
...
On Ubuntu (and many Linux distros), the default Chromium installation is a **snap package**. Snap's AppArmor confinement interferes with how aura_intelligence spawns and monitors the browser process.
...
If you must use snap Chromium, configure aura_intelligence to attach to a manually-started browser:
...
You’re using the `chrome` profile (extension relay). It expects the aura_intelligence
