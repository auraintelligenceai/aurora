---
summary: "Move (migrate) a aura_intelligence install from one machine to another"
read_when:
  - You are moving aura_intelligence to a new laptop/server
  - You want to preserve sessions, auth, and channel logins (WhatsApp, etc.)
---
# Migrating aura_intelligence to a new machine

This guide migrates a aura_intelligence Gateway from one machine to another **without redoing onboarding**.
...
- Gateway configuration (`aura_intelligence.json`)
...
### Footgun: copying only `aura_intelligence.json`
...
- `aura_intelligence status` shows the gateway running
...
- [Where does aura_intelligence store its data?](/help/faq#where-does-aura_intelligence-store-its-data)
