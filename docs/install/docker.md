...
```bash
export CLAWDBOT_HOME_VOLUME="aura_intelligence_home"
./docker-setup.sh
```
...
```bash
docker compose exec aura_intelligence-gateway node dist/index.js health --token "$CLAWDBOT_GATEWAY_TOKEN"
```
