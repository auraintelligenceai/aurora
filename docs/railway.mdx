...
Deploy aura_intelligence on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/aura_intelligence-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/aura_intelligence` — Control UI
...
- `AURA_STATE_DIR=/data/.aura` (recommended)
- `AURA_WORKSPACE_DIR=/data/workspace` (recommended)
- `AURA_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your aura_intelligence state + workspace so you can migrate to another host without losing config or memory.
