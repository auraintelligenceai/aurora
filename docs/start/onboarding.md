---
summary: "First-run onboarding flow for aura_intelligence (macOS app)"
read_when:
...
The app can install the global `aura_intelligence` CLI via npm/pnpm so terminal
...
```bash
aura_intelligence webhooks gmail setup --account you@gmail.com
```
