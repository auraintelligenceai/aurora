...
- Same path: run the app from a fixed location (for aura_intelligence, `dist/aura_intelligence.app`).
...
```bash
sudo tccutil reset Accessibility aura.mac
sudo tccutil reset ScreenCapture aura.mac
