---
summary: "Run aura_intelligence Gateway on exe.dev (VM + HTTPS proxy) for remote access"
read_when:
...
Goal: aura_intelligence Gateway running on an exe.dev VM, reachable from your laptop via: `https://<vm-name>.exe.xyz`

This page assumes exe.dev's default **exeuntu** image. If you picked a different distro, map packages accordingly.

## Beginner quick path

1) [https://exe.new/aura_intelligence](https://exe.new/aura_intelligence)
...
Shelley, [exe.dev](https://exe.dev)'s agent, can install aura_intelligence instantly with our
...
## 5) Access aura_intelligence and grant privileges

Access `https://<vm-name>.exe.xyz/?token=YOUR-TOKEN-FROM-TERMINAL`. Approve
devices with `aura_intelligence devices list` and `aura_intelligence device approve`. When in doubt,
