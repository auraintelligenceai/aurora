---
summary: "Run aura_intelligence Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want aura_intelligence running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running aura_intelligence in Docker on Hetzner or a similar provider
---

# aura_intelligence on Hetzner (Docker, Production VPS Guide)

## Goal
Run a persistent aura_intelligence Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want “aura_intelligence 24/7 for ~$5”, this is the simplest reliable setup.
...
2) Install Docker  
3) Clone aura_intelligence repository  
...
## 3) Clone the aura_intelligence repository
