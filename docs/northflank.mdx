...
Deploy aura_intelligence on Northflank with a one-click template and finish setup in your browser.
...
1. Click [Deploy aura_intelligence](https://northflank.com/stacks/deploy-aura_intelligence) to open the template.  
2. Create an [account on Northflank](https://app.northflank.com/signup) if you don’t already have one.  
3. Click **Deploy aura_intelligence now**.  
4. Set the required environment variable: `SETUP_PASSWORD`.
5. Click **Deploy stack** to build and run the aura_intelligence template.
6. Wait for the deployment to complete, then click **View resources**.
7. Open the aura_intelligence service.
8. Open the public aura_intelligence URL and complete setup at `/setup`.
9. Open the Control UI at `/aura_intelligence`.

## What you get

- Hosted aura_intelligence Gateway + Control UI
...
4) Click **Run setup**.
5) Open the Control UI at `https://<your-northflank-domain>/aura_intelligence`
