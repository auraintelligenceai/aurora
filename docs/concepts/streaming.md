...
aura_intelligence has two separate “streaming” layers:
...
When block streaming is enabled, aura_intelligence can **merge consecutive block chunks**
...
When draft streaming is active, aura_intelligence disables block streaming for that reply to avoid double-streaming.
