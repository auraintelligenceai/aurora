...
This page ties together how aura_intelligence handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. aura_intelligence keeps a
...
aura_intelligence separates the **prompt body** from the **command body**:
...
aura_intelligence can expose or hide model reasoning:
