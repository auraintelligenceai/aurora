---
summary: "Schema-accurate configuration examples for common aura_intelligence setups"
read_when:
  - Learning how to configure aura_intelligence
  - Looking for configuration examples
  - Setting up aura_intelligence for the first time
---
...
```json5
{
  ...
  // Message formatting
  messages: {
    messagePrefix: "[aura_intelligence]",
    responsePrefix: ">",
    ackReaction: "👀",
