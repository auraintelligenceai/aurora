...
aura_intelligence’s Gateway can serve an OpenResponses-compatible `POST /v1/responses` endpoint.
...
`aura_intelligence agent`), so routing/permissions/config match your Gateway.
