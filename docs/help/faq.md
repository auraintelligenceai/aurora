---
summary: "Frequently asked questions about aura_intelligence setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up aura_intelligence?](#whats-the-recommended-way-to-install-and-set-up-aura_intelligence)
  ...
  - [I can't access docs.molt.bot (SSL error). What now?](#i-cant-access-docsaura_intelligence-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or aura_intelligence not recognized](#windows-install-says-git-not-found-or-aura_intelligence-not-recognized)
  ...
  - [If I buy a Mac mini to run aura_intelligence, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-aura_intelligence-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different aura_intelligences?](#can-multiple-people-use-one-whatsapp-number-with-different-aura_intelligences)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run aura_intelligence on a dedicated machine?](#how-important-is-it-to-run-aura_intelligence-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run aura_intelligence in a VM and what are the requirements](#can-i-run-aura_intelligence-in-a-vm-and-what-are-the-requirements)
- [What is aura_intelligence?](#what-is-aura_intelligence)
  - [What is aura_intelligence, in one paragraph?](#what-is-aura_intelligence-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for aura_intelligence](#what-are-the-top-five-everyday-use-cases-for-aura_intelligence)
  - [Can aura_intelligence help with lead gen outreach ads and blogs for a SaaS](#can-aura_intelligence-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can aura_intelligence run tasks on a schedule or continuously in the background?](#can-aura_intelligence-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with aura_intelligence saved locally?](#is-all-data-used-with-aura_intelligence-saved-locally)
  - [Where does aura_intelligence store its data?](#where-does-aura_intelligence-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall aura_intelligence?](#how-do-i-completely-uninstall-aura_intelligence)
...
- [Config basics](#config-basics)
  ...
  - [Can the aura_intelligence browser run headless?](#can-the-aura_intelligence-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two aura_intelligences talk to each other (local + VPS)?](#can-two-aura_intelligences-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does aura_intelligence load environment variables?](#how-does-aura_intelligence-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of aura_intelligences one CEO and many agents](#is-there-a-way-to-make-a-team-of-aura_intelligences-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset aura_intelligence but keep it installed?](#how-do-i-completely-reset-aura_intelligence-but-keep-it-installed)
  ...
  - [Why doesn’t aura_intelligence reply in a group?](#why-doesnt-aura_intelligence-reply-in-a-group)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `aura_intelligence gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-aura_intelligence-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `aura_intelligence gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-aura_intelligence-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run aura_intelligence in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-aura_intelligence-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart aura_intelligence?](#i-closed-my-terminal-on-windows-how-do-i-restart-aura_intelligence)
  ...
  - [ELI5: `aura_intelligence gateway restart` vs `aura_intelligence gateway`](#eli5-aura_intelligence-gateway-restart-vs-aura_intelligence-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose aura_intelligence to inbound DMs?](#is-it-safe-to-expose-aura_intelligence-to-inbound-dms)
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/aura_intelligence/aura_intelligence-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ...
   aura_intelligence health --verbose   # shows the target URL + config path on errors
   ```
...
This installs aura_intelligence **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/aura_intelligence/aura_intelligence/issues
https://github.com/aura_intelligence/aura_intelligence/pulls
...
What they do:
- `aura_intelligence status`: quick snapshot of gateway/agent health + basic config.
- `aura_intelligence models status`: checks provider auth + model availability.
- `aura_intelligence doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `aura_intelligence status --all`, `aura_intelligence logs --follow`,
`aura_intelligence gateway status`, `aura_intelligence health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up aura_intelligence
...
```bash
git clone https://github.com/aura_intelligence/aura_intelligence.git
...
If you don’t have a global install yet, run it via `pnpm aura_intelligence onboard`.
...
- **Tailnet bind**: run `aura_intelligence gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `aura_intelligence dashboard`.
...
```bash
aura_intelligence gateway restart
```
2) Check status + auth:
```bash
aura_intelligence status
...
https://github.com/aura_intelligence/aura_intelligence/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docsaura_intelligence SSL error What now
...
detail: [Troubleshooting](/help/troubleshooting#docsaura_intelligence-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/aura_intelligence/aura_intelligence/tree/main/docs
...
### Windows install says git not found or aura_intelligence not recognized
...
**2) aura_intelligence is not recognized after install**
...
### How do I install aura_intelligence on Linux
...
### How do I install aura_intelligence on a VPS
...
aura_intelligence update --channel stable|beta|dev
aura_intelligence update --tag <dist-tag|version>
...
```bash
aura_intelligence update --yes --no-restart
aura_intelligence gateway restart
```
...
`aura_intelligence onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run aura_intelligence with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `aura_intelligence models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `aura_intelligence models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `aura_intelligence models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. aura_intelligence no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so aura_intelligence can keep replying while a provider is rate‑limited.
...
aura_intelligence supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. aura_intelligence fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `aura_intelligence.json`.

Steps:
1) Enable the plugin: `aura_intelligence plugins enable google-gemini-cli-auth`
2) Login: `aura_intelligence models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. aura_intelligence needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. aura_intelligence runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. aura_intelligence’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run aura_intelligence can I connect it to my MacBook Pro
...
- Use `aura_intelligence nodes status` / `aura_intelligence nodes list` to see it.
...
- DM your bot, then run `aura_intelligence logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different aura_intelligences
...
If you run aura_intelligence via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
**aura_intelligence-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run aura_intelligence on a dedicated machine
...
aura_intelligence is lightweight. For a basic Gateway + one chat channel:
...
### Can I run aura_intelligence in a VM and what are the requirements
...
## What is aura_intelligence?

### What is aura_intelligence in one paragraph

aura_intelligence is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

aura_intelligence is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for aura_intelligence
...
### Can aura_intelligence help with lead gen outreach ads and blogs for a SaaS
...
aura_intelligence draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

aura_intelligence is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use aura_intelligence when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.aura/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.aura/aura_intelligence.json`). Precedence is `<workspace>/skills` > `~/.aura/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.aura/aura_intelligence.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.aura/skills` → bundled → `skills.load.extraDirs`. `clawdhub` installs into `./skills` by default, which aura_intelligence treats as `<workspace>/skills`.
...
Debug:
```bash
aura_intelligence cron run <jobId> --force
aura_intelligence cron runs --id <jobId> --limit 50
```
...
### Can aura_intelligence run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.aura_intelligence.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-aura_intelligence-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. aura_intelligence can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.aura/skills`) to allow Linux:
   ...
   metadata: {"aura_intelligence":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (aura_intelligence only needs stdio). See [iMessage](/channels/imessage).
...
aura_intelligence memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

aura_intelligence also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, aura_intelligence auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, aura_intelligence
prefers `local`.
...
### Is all data used with aura_intelligence saved locally
...
Everything lives under `$CLAWDBOT_STATE_DIR` (default: `~/.aura`):
...
### How do I completely uninstall aura_intelligence
...
`workspace` to the repo root. The aura_intelligence repo is just source code; keep the
...
aura_intelligence reads an optional **JSON5** config from `$CLAWDBOT_CONFIG_PATH` (default: `~/.aura/aura_intelligence.json`):
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `aura_intelligence doctor --generate-gateway-token`.
...
key. **Recommended:** run `aura_intelligence configure --section web` to store it in
...
### Can the aura_intelligence browser run headless
...
5) Approve the node on the Gateway:
   ```bash
   aura_intelligence nodes pending
   aura_intelligence nodes approve <requestId>
   ```
...
Check the basics:
- Gateway is running: `aura_intelligence gateway status`
- Gateway health: `aura_intelligence status`
- Channel health: `aura_intelligence channels status`
...
### Can two aura_intelligences talk to each other local VPS
...
`aura_intelligence agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on a remote VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
aura_intelligence agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
Recover:
- Restore from backup (git or a copied `~/.aura/aura_intelligence.json`).
- If you have no backup, re-run `aura_intelligence doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `aura_intelligence config set` for small changes.
- Use `aura_intelligence configure` for interactive edits.
...
```bash
aura_intelligence gateway --tailscale serve
```
...
### How does aura_intelligence load environment variables
...
`aura_intelligence models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means aura_intelligence won’t load
...
### Is there a way to make a team of aura_intelligences one CEO and many agents
...
### How do I completely reset aura_intelligence but keep it installed
...
```bash
aura_intelligence reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `CLAWDBOT_PROFILE`), reset each state dir (defaults are `~/.aura-<profile>`).
...
headers like `# Heading`), aura_intelligence skips the heartbeat run to save API calls.
...
No. aura_intelligence runs on **your own account**, so if you’re in the group, aura_intelligence can see it.
...
```bash
aura_intelligence logs --follow --json
```
...
```bash
aura_intelligence directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt aura_intelligence reply in a group
...
- Use `aura_intelligence doctor` to spot stray workspaces and profile mismatches.
...
aura_intelligence’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, aura_intelligence currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- edit `agents.defaults.model` in `~/.aura/aura_intelligence.json`
...
Yes. aura_intelligence ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
Fix options:
- Run `aura_intelligence agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so aura_intelligence can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Sanity‑check model/auth status**
  - Use `aura_intelligence models status` to see configured models and whether providers are authenticated.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), aura_intelligence will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: aura_intelligence now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
aura_intelligence uses provider‑prefixed IDs like:
...
aura_intelligence may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `aura_intelligence models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
aura_intelligence models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
aura_intelligence models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
aura_intelligence models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
aura_intelligence models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

aura_intelligence supports both:
...
Use `aura_intelligence gateway status` and trust these lines:
...
Fix:
```bash
aura_intelligence gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

aura_intelligence enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `aura_intelligence gateway --port <port>`.

### How do I run aura_intelligence in remote mode client connects to a Gateway elsewhere
...
Notes:
- `aura_intelligence gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `aura_intelligence.control.settings.v1`.
...
Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.aura.*`, `aura_intelligence-gateway-<profile>.service`, `aura_intelligence Gateway (<profile>)`).
...
```
aura_intelligence tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/aura_intelligence/aura_intelligence-YYYY-MM-DD.log
```
...
- macOS: `$CLAWDBOT_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.aura/logs/...`; profiles use `~/.aura-<profile>/logs/...`)
...
If you run the gateway manually, `aura_intelligence gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart aura_intelligence
...
1) Is the Gateway running? `aura_intelligence gateway status`
2) Is the Gateway healthy? `aura_intelligence status`
3) Does the UI have the right token? `aura_intelligence dashboard`
...
```bash
aura_intelligence channels status
aura_intelligence channels logs --channel telegram
```
...
aura_intelligence gateway start
```
...
### ELI5 aura_intelligence gateway restart vs aura_intelligence gateway

- `aura_intelligence gateway restart`: restarts the **background service** (launchd/systemd).
- `aura_intelligence gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `aura_intelligence gateway` when
...
```bash
aura_intelligence message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose aura_intelligence to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `aura_intelligence pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `aura_intelligence pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `aura_intelligence doctor` to surface risky DM policies.
...
```bash
aura_intelligence pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. aura_intelligence only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
aura_intelligence pairing approve whatsapp <code>
```

List pending requests:

```bash
aura_intelligence pairing list whatsapp
```
...
aura_intelligence blocks **cross‑provider** messaging by default. If a tool call is bound
