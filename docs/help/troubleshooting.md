...
### `aura_intelligence: command not found`
...
You can also set `AURA_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `aura_intelligence config get agents.defaults.models`
...
If you can, include the relevant log tail from `aura_intelligence logs --follow`.
