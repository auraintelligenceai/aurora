...
read_when:
  - You are building a aura_intelligence plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---
# Plugin manifest (aura_intelligence.plugin.json)

Every plugin **must** ship a `aura_intelligence.plugin.json` file in the **plugin root**.
aura_intelligence uses this manifest to validate configuration **without executing plugin
