---
summary: "Use Qwen OAuth (free tier) in aura_intelligence"
read_when:
  - You want to use Qwen with aura_intelligence
...
```bash
aura_intelligence models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, aura_intelligence will sync credentials
