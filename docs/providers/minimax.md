---
summary: "Use MiniMax M2.1 in aura_intelligence"
read_when:
  - You want MiniMax models in aura_intelligence
...
Configure via CLI:
- Run `aura_intelligence configure`
- Select **Model/auth**
- Choose **MiniMax M2.1**
...
Configure manually via `aura_intelligence.json`:
...
- Use `aura_intelligence models list` and `aura_intelligence models set minimax/MiniMax-M2.1` to switch.
...
- Running `aura_intelligence configure` and selecting **MiniMax M2.1**, or
