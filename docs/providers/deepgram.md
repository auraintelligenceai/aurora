...
Deepgram is a speech-to-text API. In aura_intelligence it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, aura_intelligence uploads the audio file to Deepgram and injects the transcript
