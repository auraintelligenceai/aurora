...
### With aura_intelligence

You can point aura_intelligence at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or aura_intelligence
...
- [Anthropic provider](/providers/anthropic) - Native aura_intelligence integration with Claude setup-token or API keys
