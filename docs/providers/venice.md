---
summary: "Use Venice AI privacy-focused models in aura_intelligence"
read_when:
  - You want privacy-focused inference in aura_intelligence
...
## Why Venice in aura_intelligence
...
```bash
aura_intelligence onboard --auth-choice venice-api-key
```
...
```bash
aura_intelligence chat --model venice/llama-3.3-70b "Hello, are you working?"
```

## Model Selection

After setup, aura_intelligence shows all available Venice models. Pick based on your needs:
...
```bash
aura_intelligence models set venice/claude-opus-45
aura_intelligence models set venice/llama-3.3-70b
```

List all available models:

```bash
aura_intelligence models list | grep venice
```

## Configure via `aura_intelligence configure`

1. Run `aura_intelligence configure`
2. Select **Model/auth**
3. Choose **Venice AI**
...
aura_intelligence automatically discovers models from the Venice API when `VENICE_API_KEY` is set. If the API is unreachable, it falls back to a static catalog.
...
aura_intelligence chat --model venice/llama-3.3-70b

# Use Claude via Venice (anonymized)
aura_intelligence chat --model venice/claude-opus-45

# Use uncensored model
aura_intelligence chat --model venice/venice-uncensored

# Use vision model with image
aura_intelligence chat --model venice/qwen3-vl-235b-a22b

# Use coding model
aura_intelligence chat --model venice/qwen3-coder-480b-a35b-instruct
```
...
The Venice model catalog updates dynamically. Run `aura_intelligence models list` to see currently available models. Some models may be temporarily offline.
