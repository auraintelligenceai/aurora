...
summary: Machine-checked security models for aura_intelligence’s highest-risk paths.
permalink: /security/formal-verification/
---

# Formal Verification (Security Models)

This page tracks aura_intelligence’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that aura_intelligence enforces its
...
**What this is not (yet):** a proof that “aura_intelligence is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/aura-formal-models](https://github.com/vignesh07/aura-formal-models).
...
```bash
git clone https://github.com/vignesh07/aura-formal-models
cd aura-formal-models
