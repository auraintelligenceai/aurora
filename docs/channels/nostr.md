...
read_when:
  - You want aura_intelligence to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables aura_intelligence to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`aura_intelligence onboard`) and `aura_intelligence channels add` list optional channel plugins.
...
```bash
aura_intelligence plugins install @aura_intelligence/nostr
```

Use a local checkout (dev workflows):

```bash
aura_intelligence plugins install --link <path-to-aura_intelligence>/extensions/nostr
```
  ...
  "channels": {
    "nostr": {
      ...
      "profile": {
        ...
        "displayName": "aura_intelligence",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "aura_intelligence@example.com",
        "lud16": "aura_intelligence@example.com"
      }
    }
  }
}
