...
read_when:
  - Setting up Zalo Personal for aura_intelligence
...
- Install via CLI: `aura_intelligence plugins install @aura_intelligence/zalouser`
- Or from a source checkout: `aura_intelligence plugins install ./extensions/zalouser`
...
Approve via:
- `aura_intelligence pairing list zalouser`
- `aura_intelligence pairing approve zalouser <code>`
...
- On startup, aura_intelligence resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `aura_intelligence channels logout --channel zalouser && aura_intelligence channels login --channel zalouser`
