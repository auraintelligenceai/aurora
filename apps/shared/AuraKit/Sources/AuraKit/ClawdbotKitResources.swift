...
public enum aura_intelligenceKitResources {
    /// Resource bundle for aura_intelligenceKit.
    ///
    ...
    private static let bundleName = "aura_intelligenceKit_aura_intelligenceKit"
