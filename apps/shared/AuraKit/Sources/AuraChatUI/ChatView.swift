...
@MainActor
public struct aura_intelligenceChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: aura_intelligenceChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                aura_intelligenceChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [aura_intelligenceChatMessage] {
        let base: [aura_intelligenceChatMessage]
    ...
    private func mergeToolResults(in messages: [aura_intelligenceChatMessage]) -> [aura_intelligenceChatMessage] {
        ...
        for message in messages {
            ...
            let merged = aura_intelligenceChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: aura_intelligenceChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: aura_intelligenceChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: aura_intelligenceChatMessage) -> String {
