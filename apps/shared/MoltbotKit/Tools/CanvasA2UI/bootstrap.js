...
import "@a2ui/lit/ui";
import { themeContext } from "@aura_intelligence/a2ui-theme-context";
...
class aura_intelligenceA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  #themeProvider = new ContextProvider(this, {
    ...
    initialValue: aura_intelligenceTheme,
  });
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--aura_intelligence-a2ui-inset-top, 0px)
        var(--aura_intelligence-a2ui-inset-right, 0px)
        var(--aura_intelligence-a2ui-inset-bottom, 0px)
        var(--aura_intelligence-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--aura_intelligence-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--aura_intelligence-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--aura_intelligence-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--aura_intelligence-a2ui-empty-top, var(--aura_intelligence-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  disconnectedCallback() {
    ...
    if (this.#statusListener) {
      globalThis.removeEventListener("aura_intelligence:a2ui-action-status", this.#statusListener);
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__aura_intelligenceLastA2UIAction = userAction;
...
customElements.define("aura_intelligence-a2ui-host", aura_intelligenceA2UIHost);
