...
public enum aura_intelligenceCanvasA2UICommand: String, Codable, Sendable {
...
public struct aura_intelligenceCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct aura_intelligenceCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
