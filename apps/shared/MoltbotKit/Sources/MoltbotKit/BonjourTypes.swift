...
public enum aura_intelligenceBonjour {
    // v0: internal-only, subject to rename.
    public static let gatewayServiceType = "_aura_intelligence-gw._tcp"
    public static let gatewayServiceDomain = "local."
    public static let wideAreaGatewayServiceDomain = "aura_intelligence.internal."
