...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = aura_intelligenceLocationMode.off.rawValue
        ...
        NavigationStack {
            Form {
                ...
                Section("Screen") {
                    ...
                    Text("Keeps the screen awake while aura_intelligence is open.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                }
            }
    ...
    private var locationMode: aura_intelligenceLocationMode {
        aura_intelligenceLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
