...
final class ScreenController {
    ...
    /// Callback invoked when a aura_intelligence:// deep link is tapped in the canvas
    ...
    fileprivate func applyDebugStatusIfNeeded() {
        ...
        (() => {
          try {
            const api = globalThis.__aura_intelligence;
            if (!api) return;
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = aura_intelligenceKitResources.bundle
...
/// Handles navigation policy to intercept aura_intelligence:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept aura_intelligence:// deep links
        if url.scheme == "aura_intelligence" {
