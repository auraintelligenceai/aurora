...
actor CameraController {
    ...
    func snap(params: aura_intelligenceCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: aura_intelligenceCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("aura_intelligence-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("aura_intelligence-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: aura_intelligenceCameraFacing,
