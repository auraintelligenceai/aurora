...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "aura", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "aura", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [aura_intelligenceChatMessage] = messages.compactMap { item in
