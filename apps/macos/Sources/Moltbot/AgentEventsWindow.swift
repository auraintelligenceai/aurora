...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: aura_intelligenceProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": aura_intelligenceProtocol.AnyCodable("start"),
                "name": aura_intelligenceProtocol.AnyCodable("bash"),
            ],
            summary: nil)
