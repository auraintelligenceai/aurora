...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "aura", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        aura_intelligencePaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        aura_intelligencePaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
