...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .aura_intelligenceSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? aura_intelligencePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? aura_intelligencePaths.stateDirURL.path
...
extension Notification.Name {
    static let aura_intelligenceSelectSettingsTab = Notification.Name("aura_intelligenceSelectSettingsTab")
}
