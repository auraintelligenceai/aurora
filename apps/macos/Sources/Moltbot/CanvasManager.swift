...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "aura", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("aura_intelligence/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__aura_intelligence__/a2ui/").absoluteString + "?platform=macos"
    }
