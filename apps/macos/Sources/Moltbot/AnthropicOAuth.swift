...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (aura_intelligence token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: aura_intelligenceOAuthStore.AnthropicOAuthStatus = aura_intelligenceOAuthStore
...
enum aura_intelligenceOAuthStore {
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "aura_intelligence OAuth token file not found"
            case .unreadableFile: "aura_intelligence OAuth token file not readable"
            case .invalidJSON: "aura_intelligence OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in aura_intelligence OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "aura_intelligence OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.aura_intelligenceOAuthDirEnv]?
