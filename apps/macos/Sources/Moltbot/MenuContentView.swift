...
/// Menu contents for the aura_intelligence menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About aura_intelligence") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "aura_intelligence Not Configured"
        case .remote:
            "Remote aura_intelligence Active"
        case .local:
            "aura_intelligence Active"
        }
    }
