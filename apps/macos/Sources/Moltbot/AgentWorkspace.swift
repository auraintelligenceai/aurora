...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "aura", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return aura_intelligenceConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.aura_intelligence/aura_intelligence.json
