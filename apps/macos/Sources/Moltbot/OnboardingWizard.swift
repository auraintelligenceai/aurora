...
private let onboardingWizardLogger = Logger(subsystem: "aura", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between aura_intelligenceProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = aura_intelligenceProtocol.AnyCodable
