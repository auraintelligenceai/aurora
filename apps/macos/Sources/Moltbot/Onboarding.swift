...
enum UIStrings {
    static let welcomeTitle = "Welcome to aura_intelligence"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: aura_intelligenceOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: aura_intelligenceChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g aura_intelligence@\(version)"
    }
