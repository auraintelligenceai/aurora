...
Modern Android node app: connects to the **Gateway WebSocket** (`_aura-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm aura gateway --port 18789 --verbose
```
